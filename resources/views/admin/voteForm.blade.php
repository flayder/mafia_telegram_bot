...
<label for='id'>{{ \App\Models\Vote::labels()['id'] }}</label>
<input class='form-control @error("id") is-invalid @enderror' id='id' name='id' value='{{ $model->id }}' >
</div>
<div class="form-group">
<label for='voiting_id'>{{ \App\Models\Vote::labels()['voiting_id'] }}</label>
...
<div class="form-group">
<label for='gamer_id'>{{ \App\Models\Vote::labels()['gamer_id'] }}</label>
...
<div class="form-group">
<label for='vote_user_id'>{{ \App\Models\Vote::labels()['vote_user_id'] }}</label>
